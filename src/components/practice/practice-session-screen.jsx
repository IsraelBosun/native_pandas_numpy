...
// Cram/starred cards aren't scheduled, so the 4-grade SM-2 interval preview
// would be meaningless here — just a plain correct/missed self-check instead.
